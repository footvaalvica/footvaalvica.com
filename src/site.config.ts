...
const config: SiteConfig = {
  ...
  site: 'https://footvaalvica.github.io',
  // The name of your site, used in the title and for SEO.
  title: 'footvaalvica.com',
  // The description of your site, used for SEO and RSS feed.
  description:
    'A simple personal website for a blog and Porfolio built with Astro and the MultiTerm theme.',
  ...
  socialCardAvatarImage: 'https://avatars.githubusercontent.com/u/11351574?v=4',
  ...
  navLinks: [
    ...
    {
      name: 'CV',
      url: '/mateusp_resume.pdf',
    },
    {
      name: 'GitHub',
      url: 'https://github.com/footvaalvica',
      external: true,
    },
  ],
  ...
  socialLinks: {
    github: 'https://github.com/footvaalvica',
    email: 'mateusleitepinho@gmail.com',
    linkedin: 'https://www.linkedin.com/in/mateus-leite-pinho/',
